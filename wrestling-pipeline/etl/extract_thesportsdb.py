...
try:
    ...
    from etl.extractors.thesportsdb import extract_all, fetch_wrestlers_by_name, fetch_players_by_team, search_teams_by_name, search_teams_by_league, run_and_save, run_and_save_with_images
    from etl.utils.retry_utils import requests_get_with_retry
except ImportError:
    from extractors import thesportsdb as _impl
    from extractors.thesportsdb import extract_all, fetch_wrestlers_by_name, fetch_players_by_team, search_teams_by_name, search_teams_by_league, run_and_save, run_and_save_with_images
