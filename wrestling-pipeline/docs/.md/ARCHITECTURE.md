...
Este documento debe considerarse el manual técnico vivo del pipeline. Si quieres, lo publico en otro lugar del repo o lo amplío con diagramas de secuencia (Mermaid) y ejemplos de payloads/metadata generados.